...
export default function ProductDetailPage() {
  ...
  // Extract key specifications for meta description
  const specHighlights = Object.entries(product.specifications)
    .slice(0, 3)
  ...
  return (
    <>
      <SEO 
        title={product.name}
        description={`${product.description.slice(0, 100)}... ${specHighlights}`}
        keywords={`${product.category}, heavy machinery, ${product.name.toLowerCase()}, construction equipment`}
        canonicalUrl={`https://amarisco.com/products/${product.id}`}
